...
class main_window():
    ...
    def curves_adjust(self):
        ...
        self.ca.update(self.ui.cbox_curv_channel.currentText())
    ...
    def __display_image_when_open(self, file_name):
        ...
        self.ca = curves_adjust.Curves(self.handle_img, self.ui.label_curv, self.ui.label_main, self.ui.label_hist)
